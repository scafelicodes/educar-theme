<?php get_header(); ?>
                       ...
                       <div class="container">
                           <div class="row ">
                               ...
                               <div class="col-xl-6 col-lg-5 d-none d-lg-block">
                                    <div class="slide-img text-right">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="features-title text-center">
                                ...
                                <h2>Marque presença nas redes sociais</h2>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="features-title text-center mb-80">
                            ...
                            <h2>Comunicação digital durante todo o ano</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="latest-blog-area pt-100 pb-100">
